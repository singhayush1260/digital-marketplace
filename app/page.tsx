...
const Home = () => {
  return (
    <section className="max-w-7xl mx-auto px-4 md:px-8 mt-8 md:mt-12 mb-20">
      <div className="max-w-3xl mx-auto text-2xl sm:text-3xl lg:text-6xl font-semibold text-center">
